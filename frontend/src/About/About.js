    ...
    return (
        <div className="About">
            <div className="Project-Scale-Pannel">
                ...
                <p className="Project-Scale-Text"> <span style={{color:"#5D0B98", fontWeight:"800", marginRight: "16px"}}> &bull; </span> Created by a team of <span className="Project-Scale-Text-Emph">3 web developers</span> at University of South Florida to demonstrate technical skills</p>
